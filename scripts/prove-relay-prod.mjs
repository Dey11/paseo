...
const relayEndpoint = args["relay-endpoint"] ?? process.env.PASEO_RELAY_ENDPOINT;
const baseUrl = args["base-url"] ?? process.env.PASEO_APP_URL;
...
if (!relayEndpoint || typeof relayEndpoint !== "string") {
  console.error("Missing relay endpoint. Provide --relay-endpoint or PASEO_RELAY_ENDPOINT.");
  process.exit(2);
}
if (!baseUrl || typeof baseUrl !== "string") {
  console.error("Missing app URL. Provide --base-url or PASEO_APP_URL.");
  process.exit(2);
}
