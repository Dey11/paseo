...
Start the `com.dey.hanabicode.debug` dev client against the intended Metro server first;
...
The scripts assume a development build with package id `com.dey.hanabicode.debug`, an
