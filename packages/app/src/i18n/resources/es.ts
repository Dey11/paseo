...
export const es: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "El archivo no está disponible aquí porque este espacio de trabajo no se creó como un árbol de trabajoHanabiCode",
          mergePrNoForge:
      ...
      commitComposer: {
        ...
        generationFailed: "No se pudo generar un mensaje de commit.",
        generationUnsupported: "Actualiza el host para generar mensajes de commit.",
        ...
        includeFile: "Incluir {{path}} en el commit",
      ...
      sourceControl: {
        ...
        unstageAll: "Quitar preparación de todo",
        stageFile: "Preparar {{path}}",
        unstageFile: "Quitar preparación de {{path}}",
        stageBeforeCommit: "Prepara archivos antes de confirmar.",
        indexUpdateFailed: "No se pudieron actualizar los cambios preparados.",
        resizeSections: "Cambiar el tamaño de las secciones preparadas y sin preparar",
      },
      diff: {
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Deje queHanabiCodeinicie y detenga el demonio incorporado",
        ...
        pausedStopFailed:
          "La gestión del demonio integrado se pausó, peroHanabiCodeno pudo detener el demonio.",
      ...
      keepRunning: {
        ...
        hint: "Daemonsigue ejecutándose cuando sales deHanabiCode",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel: "Estás ejecutando la compilaciónInteldeHanabiCodeenRosettaenApple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Prueba de notificaciónHanabiCode",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "No se puede instalar elHanabiCodeCLI.",
      },
      skills: {
  ...
  rootError: {
    title: "HanabiCode tuvo un problema.",
  ...
  pairing: {
    ...
    direct: {
      title: "Conexión directa",
      helper: "Ingrese la dirección de un servidorHanabiCode.",
      fields: {
        host: "Host",
        port: "Puerto",
        password: "Contraseña",
    ...
    device: {
      ...
      relayDocsAccessibility: "Leer cómo funciona el relé de HanabiCode",
      ...
      updateRequired: "Actualice el host para habilitar el relé desde HanabiCode Desktop.",
      unavailable: "Oferta de maridaje no disponible.",
      hint: "Escanee este códigoQRconHanabiCodeen su teléfono o copie el enlace a continuación.",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "llamó a HanabiCode {{count}} vez",
      other: "llamó a HanabiCode {{count}} veces",
    },
    and: "y",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "HanabiCode entregó la notificación al sistema operativo.",
    ...
    metadataGeneration: {
      ...
      description:
        "Elige el modelo que HanabiCode usa para títulos de espacios de trabajo, nombres de ramas, mensajes de commit y borradores de pull requests",
      selection: "Selección de modelo",
      automatic: "Automática",
      preferred: "Manual",
      automaticHint: "HanabiCode elige un modelo rápido disponible",
      preferredHint: "Elige el modelo que usa HanabiCode",
      model: "Modelo",
      fallbackHint: "Si no está disponible, HanabiCode usa otro modelo disponible",
      docs: "Documentación",
    ...
    general: {
      ...
      browserData: {
        ...
        description:
          "Las pestañas del navegador comparten inicios de sesión y datos de sitios en HanabiCode.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Esto actualizaHanabiCodeen esta computadora.",
    ...
    integrations: {
      ...
      skills: {
        ...
        updateTitle: "¿Actualizar las habilidades deHanabiCode?",
        updateFallback: "Sincronice las habilidades incluidas con su máquina.",
        uninstallTitle: "¿Desinstalar las habilidadesHanabiCode?",
        uninstallMessage:
          "Elimina todas las habilidades de orquestaciónHanabiCodede ~/.agents, ~/.claude, ~/.codex.",
    ...
    host: {
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Habilitar herramientasHanabiCode",
          hint: "Los agentes podrán gestionar árboles de trabajo, agentes y horarios.",
          accessibilityLabel: "Inyectar herramientasHanabiCode",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este anfitrión está desconectado.HanabiCodese vuelve a conectar automáticamente; espere hasta que vuelva a estar en línea antes de reiniciar.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "No se pudo enviar la solicitud de reinicio.HanabiCodese vuelve a conectar automáticamente; inténtelo nuevamente una vez que el host se muestre en línea.",
          dialogFailedMessage:
            "No se puede abrir el cuadro de diálogo de confirmación de reinicio.",
        },
        update: {
          desktopManagedHint:
            "Este daemon está administrado por HanabiCode Desktop. Actualiza HanabiCode Desktop en el host.",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "HanabiCodesupervisa el proceso y asigna un puerto vía $PASEO_PORT",
        actions: {
          add: "Agregar guión",
          edit: "Editar",
          remove: "Eliminar",
      ...
      metadata: {
        title: "Generación de metadatos",
        info: "Instrucciones específicas del proyecto inyectadas en los mensajes de IA queHanabiCodeutiliza para generar metadatos; úselas para hacer cumplir las convenciones de su equipo, como la denominación de ramas, el estilo de confirmación o el formatoPR.",
