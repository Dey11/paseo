...
export const ru: TranslationResources = {
  ...
  workspace: {
    ...
    ports: {
      title: "Проброшенные порты",
      description:
        "Откройте сервис рабочей области на этом компьютере через зашифрованное подключение к хосту.",
      endpoint: "локальный адрес",
      manualPlaceholder: "Номер порта",
      protocol: "Протокол",
      fallbackPort: "Локальный порт {{requestedPort}} занят; используется {{localPort}}.",
      observationMissing:
        "Хост больше не обнаруживает этот порт. Текущий проброс остаётся активным.",
      loading: "Поиск портов рабочей области…",
      empty: "Для этой рабочей области не найдены прослушиваемые порты.",
      noWorkspace: "Откройте рабочую область, чтобы увидеть её порты.",
      hostDisconnected: "Подключитесь к хосту повторно, чтобы использовать проброс портов.",
      updateHost: "Обновите демон хоста, чтобы использовать проброс портов.",
      unsupportedConnection: "Переключите хост на TCP- или relay-подключение для проброса портов.",
      discoveryUnavailable: "Автоматический поиск недоступен. Введите порт вручную.",
      actions: { forward: "Пробросить", open: "Открыть", copy: "Копировать", stop: "Остановить" },
      states: {
        available: "Доступен",
      ...
      errors: {
        runtime: "Ошибка проброса порта",
        watch: "Не удалось загрузить порты рабочей области.",
        forward: "Не удалось пробросить этот порт.",
        stop: "Не удалось остановить проброс порта.",
        copy: "Не удалось скопировать локальный адрес.",
        open: "Не удалось открыть локальный адрес.",
        desktopUpdate: "Обновите настольное приложение, чтобы использовать проброс портов.",
      },
    },
    header: {
      actions: {
