...
export const ar: TranslationResources = {
  ...
  workspace: {
    ...
    ports: {
      ...
      description: "افتح خدمة مساحة العمل على هذا الكمبيوتر عبر الاتصال المشفّر بالمضيف.",
      endpoint: "نقطة النهاية المحلية",
      manualPlaceholder: "رقم المنفذ",
      protocol: "البروتوكول",
      fallbackPort: "المنفذ المحلي {{requestedPort}} مشغول؛ يُستخدم {{localPort}}.",
      observationMissing: "لم يعد المضيف يكتشف هذا المنفذ. يظل التوجيه الحالي نشطًا.",
      loading: "جارٍ البحث عن منافذ مساحة العمل…",
      empty: "لم يتم العثور على منافذ تستمع في مساحة العمل هذه.",
      noWorkspace: "افتح مساحة عمل لعرض منافذها.",
      hostDisconnected: "أعد الاتصال بالمضيف لاستخدام إعادة توجيه المنافذ.",
      updateHost: "حدّث برنامج المضيف لاستخدام إعادة توجيه منافذ مساحة العمل.",
      unsupportedConnection: "حوّل هذا المضيف إلى اتصال TCP أو اتصال ترحيل لتوجيه المنافذ.",
      discoveryUnavailable: "الاكتشاف التلقائي غير متاح. أدخل منفذًا يدويًا.",
      actions: { forward: "توجيه", open: "فتح", copy: "نسخ", stop: "إيقاف" },
      states: {
        available: "متاح",
      ...
      errors: {
        runtime: "خطأ في إعادة توجيه المنافذ",
        watch: "تعذّر تحميل منافذ مساحة العمل.",
        forward: "تعذّرت إعادة توجيه هذا المنفذ.",
        stop: "تعذّر إيقاف إعادة توجيه المنفذ.",
        copy: "تعذّر نسخ نقطة النهاية المحلية.",
        open: "تعذّر فتح نقطة النهاية المحلية.",
        desktopUpdate: "حدّث تطبيق سطح المكتب لاستخدام إعادة توجيه المنافذ.",
      },
    },
    header: {
      actions: {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "الأرشيف غير متاح هنا لأنه لم يتم إنشاء مساحة العمل هذه كشجرة عمل HanabiCode",
      ...
      commitComposer: {
        messageLabel: "رسالة الالتزام",
        placeholder: "صف تغييراتك",
        generate: "إنشاء",
        generating: "جار الإنشاء...",
        generationFailed: "تعذر إنشاء رسالة الالتزام.",
        generationUnsupported: "حدّث المضيف لإنشاء رسائل الالتزام.",
        selectAll: "تحديد كل التغييرات",
        selectedCount: "تم تحديد {{count}} من {{total}}",
        selectAtLeastOne: "حدد ملفاً واحداً على الأقل للالتزام.",
        includeFile: "تضمين {{path}} في الالتزام",
        discardFile: "تجاهل التغييرات في {{path}}",
        commitFailed: "تعذر الالتزام بالتغييرات.",
      },
      sourceControl: {
        staged: "التغييرات المرحّلة",
        unstaged: "التغييرات",
        stage: "ترحيل",
        unstage: "إلغاء الترحيل",
        stageAll: "ترحيل الكل",
        unstageAll: "إلغاء ترحيل الكل",
        stageFile: "ترحيل {{path}}",
        unstageFile: "إلغاء ترحيل {{path}}",
        stageBeforeCommit: "رحّل الملفات قبل الالتزام.",
        indexUpdateFailed: "تعذر تحديث التغييرات المرحّلة.",
        resizeSections: "تغيير حجم قسمي التغييرات المرحّلة وغير المرحّلة",
      },
      diff: {
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "اسمح لـ HanabiCode ببدء تشغيل البرنامج الخفي المدمج وإيقافه",
        ...
        pausedStopFailed:
          "تم إيقاف إدارة البرنامج الخفي المضمنة مؤقتًا، لكن لم يتمكن HanabiCode من إيقاف البرنامج الخفي.",
        updateFailed: "غير قادر على تحديث إدارة البرنامج الخفي المضمنة.",
      },
      keepRunning: {
        title: "استمر في تشغيل البرنامج الخفي بعد الإقلاع عن التدخين",
        hint: "يستمر تشغيل Daemon عند إنهاء HanabiCode",
      },
      logs: {
        title: "ملف السجل",
    ...
    rosetta: {
      ...
      runningIntel: "أنت تقوم بتشغيل إصدار Intel من HanabiCode ضمن Rosetta على Apple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "اختبار الإخطار HanabiCode",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "غير قادر على تثبيت HanabiCodeCLI.",
      },
      skills: {
  ...
  pairing: {
    ...
    direct: {
      title: "اتصال مباشر",
      helper: "أدخل عنوان خادم HanabiCode.",
      fields: {
        host: "Host",
        port: "ميناء",
    ...
    device: {
      ...
      relayDocsAccessibility: "اقرأ كيفية عمل تتابع HanabiCode",
      ...
      updateRequired: "حدّث المضيف لتمكين التتابع من HanabiCode Desktop.",
      unavailable: "عرض الاقتران غير متاح.",
      hint: "قم بمسح رمز QR هذا باستخدام HanabiCode على هاتفك، أو انسخ الرابط أدناه.",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "استدعى HanabiCode {{count}} مرة",
      other: "استدعى HanabiCode {{count}} مرات",
    },
    and: "و",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "سلّم HanabiCode الإشعار إلى نظام التشغيل.",
    ...
    metadataGeneration: {
      ...
      description:
        "اختر النموذج الذي يستخدمه HanabiCode لعناوين مساحات العمل وأسماء الفروع ورسائل الالتزام ومسودات طلبات السحب",
      selection: "اختيار النموذج",
      automatic: "تلقائي",
      preferred: "يدوي",
      automaticHint: "يختار HanabiCode نموذجًا سريعًا متاحًا",
      preferredHint: "اختر النموذج الذي يستخدمه HanabiCode",
      model: "النموذج",
      fallbackHint: "إذا لم يكن متاحًا، يستخدم HanabiCode نموذجًا آخر متاحًا",
      docs: "الوثائق",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "تتشارك علامات تبويب المتصفح تسجيلات الدخول وبيانات المواقع عبر HanabiCode.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "يؤدي هذا إلى تحديث HanabiCode على هذا الكمبيوتر",
    ...
    integrations: {
      ...
      skills: {
        ...
        updateTitle: "تحديث مهارات HanabiCode ؟",
        updateFallback: "مزامنة المهارات المجمعة لجهازك.",
        uninstallTitle: "إلغاء تثبيت مهارات HanabiCode ؟",
        uninstallMessage: "يزيل جميع مهارات تنسيق HanabiCode من ~/.agents ، ~/.claude ، ~/.codex.",
    ...
    host: {
      ...
      orchestration: {
        ...
        enableTools: {
          title: "تمكين أدوات HanabiCode",
          hint: "سيتمكن الوكلاء من إدارة أشجار العمل والوكلاء والجداول الزمنية",
          accessibilityLabel: "حقن أدوات HanabiCode",
        },
        systemPrompt: {
          title: "موجه النظام",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "هذا المضيف غير متصل.  يقوم HanabiCode بإعادة الاتصال تلقائيًا - انتظر حتى يتم الاتصال بالإنترنت مرة أخرى قبل إعادة التشغيل.",
          requestFailedTitle: "خطأ",
          requestFailedMessage:
            "فشل في إرسال طلب إعادة التشغيل.  يقوم HanabiCode بإعادة الاتصال تلقائيًا - حاول مرة أخرى بمجرد ظهور المضيف على أنه متصل بالإنترنت.",
          dialogFailedMessage: "غير قادر على فتح مربع حوار تأكيد إعادة التشغيل.",
        },
        update: {
          desktopManagedHint:
            "يدير HanabiCode Desktop هذا البرنامج الخفي. حدّث HanabiCode Desktop على المضيف.",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "يشرف HanabiCode على العملية ويعين منفذًا عبر $PASEO_PORT",
        actions: {
      ...
      metadata: {
        ...
        info: "تعليمات خاصة بالمشروع يتم إدخالها في الذكاء الاصطناعي الذي يستخدمه HanabiCode لإنشاء بيانات التعريف - استخدمها لفرض اصطلاحات فريقك مثل تسمية الفرع أو نمط الالتزام أو تنسيق PR",
