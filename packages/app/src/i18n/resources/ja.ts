...
export const ja: TranslationResources = {
  ...
  workspace: {
    ...
    ports: {
      title: "転送ポート",
      description:
        "暗号化されたホスト接続を通じて、このコンピューターでワークスペースのサービスを開きます。",
      endpoint: "ローカルエンドポイント",
      manualPlaceholder: "ポート番号",
      protocol: "プロトコル",
      fallbackPort: "ローカルポート{{requestedPort}}は使用中のため、{{localPort}}を使用します。",
      observationMissing: "ホストはこのポートを検出しなくなりました。既存の転送は有効です。",
      loading: "ワークスペースのポートを検索中…",
      empty: "このワークスペースで待機中のポートは見つかりませんでした。",
      noWorkspace: "ポートを表示するにはワークスペースを開いてください。",
      hostDisconnected: "ポート転送を使用するにはホストに再接続してください。",
      updateHost: "ポート転送を使用するにはホストのデーモンを更新してください。",
      unsupportedConnection: "ポートを転送するにはTCPまたはリレー接続に切り替えてください。",
      discoveryUnavailable: "自動検出は利用できません。ポートを手動で入力してください。",
      actions: { forward: "転送", open: "開く", copy: "コピー", stop: "停止" },
      states: {
        available: "利用可能",
        unavailable: "利用不可",
        starting: "開始中",
      ...
      errors: {
        runtime: "ポート転送エラー",
        watch: "ワークスペースのポートを読み込めませんでした。",
        forward: "このポートを転送できませんでした。",
        stop: "ポート転送を停止できませんでした。",
        copy: "ローカルエンドポイントをコピーできませんでした。",
        open: "ローカルエンドポイントを開けませんでした。",
        desktopUpdate: "ポート転送を使用するにはデスクトップアプリを更新してください。",
      },
    },
    header: {
      actions: {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "このワークスペースはHanabiCodeワークツリーとして作成されていないため、アーカイブはここでは利用できません",
      ...
      sourceControl: {
        ...
        unstageFile: "{{path}} のステージを解除",
        stageBeforeCommit: "コミット前にファイルをステージしてください。",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        title: "組み込みデーモンを管理",
        hint: "HanabiCodeが組み込みデーモンを起動・停止できるようにする",
        pauseTitle: "組み込みデーモンを一時停止",
        pauseMessage:
          "これにより組み込みデーモンが即座に停止します。組み込みデーモンに接続されている実行中のエージェントとターミナルが停止されます。",
        pauseAndStop: "一時停止して停止",
        registrationFailed:
          "組み込みデーモンは起動しましたが、HanabiCodeがlocalhostの接続を保存できませんでした。デーモン管理をオフにしてから再度オンにするか、localhostを手動で追加してください。",
        pausedStopFailed:
          "組み込みデーモン管理は一時停止されましたが、HanabiCodeがデーモンを停止できませんでした。",
        updateFailed: "組み込みデーモン管理を更新できません。",
      },
      keepRunning: {
        title: "終了後もデーモンを実行し続ける",
        hint: "HanabiCodeを終了してもデーモンは実行し続けます",
      },
      logs: {
        title: "ログファイル",
        modalTitle: "デーモンログ",
    ...
    rosetta: {
      ...
      runningIntel: "Apple Silicon上のRosettaでHanabiCodeのIntelビルドを実行しています。",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "HanabiCode CLIをインストールできません。",
      },
      skills: {
  ...
  pairing: {
    ...
    direct: {
      title: "直接接続",
      helper: "HanabiCodeサーバーのアドレスを入力してください。",
      fields: {
        host: "ホスト",
        port: "ポート",
        password: "パスワード",
    ...
    device: {
      ...
      relayDocs: "リレーの仕組み",
      relayDocsAccessibility: "HanabiCode リレーの仕組みを読む",
      enableRelay: "リレーを有効にする",
      enablingRelay: "有効化中...",
      notNow: "今はしない",
      directConnectionHint:
        "リレーを使わない場合は、TCP、Tailscale、または別の VPN で直接接続してください。QR コードは作成されません。",
      updateRequired: "HanabiCode Desktop からリレーを有効にするにはホストを更新してください。",
      unavailable: "ペアリングオファーが利用できません。",
      hint: "スマートフォンのHanabiCodeでこのQRコードをスキャンするか、以下のリンクをコピーしてください。",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "HanabiCodeを{{count}}回呼び出し",
      other: "HanabiCodeを{{count}}回呼び出し",
    },
    and: "および",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "HanabiCode が通知をオペレーティングシステムに渡しました。",
    ...
    metadataGeneration: {
      ...
      automatic: "自動",
      preferred: "手動",
      automaticHint: "HanabiCode が利用可能な高速モデルを選択します",
      preferredHint: "HanabiCode が使用するモデルを選択します",
      model: "モデル",
      fallbackHint: "利用できない場合、HanabiCode は別の利用可能なモデルを使用します",
      docs: "ドキュメント",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "このコンピューターのHanabiCodeを更新します",
    ...
    integrations: {
      ...
      skills: {
        ...
        updateTitle: "HanabiCodeスキルを更新しますか？",
        updateFallback: "バンドルされたスキルをマシンに同期します。",
        uninstallTitle: "HanabiCodeスキルをアンインストールしますか？",
        uninstallMessage:
          "~/.agents、~/.claude、~/.codexからすべてのHanabiCodeオーケストレーションスキルを削除します。",
        choose: "スキルを選択",
        chooseAll: "すべてのスキル",
        chooseAllHint:
    ...
    host: {
      ...
      orchestration: {
        ...
        enableTools: {
          title: "HanabiCodeツールを有効にする",
          hint: "エージェントがワークツリー、エージェント、スケジュールを管理できるようになります",
          accessibilityLabel: "HanabiCodeツールを有効にする",
        },
        systemPrompt: {
          title: "システムプロンプト",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "このホストはオフラインです。HanabiCodeが自動再接続します。再起動は、ホストがオンラインに戻ってから行ってください。",
          requestFailedTitle: "エラー",
          requestFailedMessage:
            "再起動リクエストの送信に失敗しました。HanabiCodeは自動的に再接続します。ホストがオンラインになったら再試行してください。",
          dialogFailedMessage: "再起動確認ダイアログを開けませんでした。",
        },
        update: {
          desktopManagedHint:
            "このデーモンはHanabiCode Desktopによって管理されています。ホスト上のHanabiCode Desktopを更新してください。",
          title: "デーモンを更新",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "HanabiCodeがプロセスを監督し、$PASEO_PORTを通じてポートを割り当てます",
        actions: {
          add: "スクリプトを追加",
          edit: "編集",
          remove: "削除",
      ...
      metadata: {
        title: "メタデータ生成",
        info: "HanabiCodeがメタデータ生成に使うAIプロンプトへ追加する、プロジェクト固有の指示です。ブランチ名、コミット形式、PR形式など、チームの規約を反映するために使います。",
        branchName: "ブランチ名",
