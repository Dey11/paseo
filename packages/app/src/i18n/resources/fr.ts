...
export const fr: TranslationResources = {
  ...
  workspace: {
    ...
    ports: {
      title: "Ports transférés",
      description:
        "Ouvrez un service de l’espace de travail sur cet ordinateur via la connexion chiffrée à l’hôte.",
      endpoint: "adresse locale",
      manualPlaceholder: "Numéro de port",
      protocol: "Protocole",
      fallbackPort: "Le port local {{requestedPort}} était occupé ; utilisation de {{localPort}}.",
      observationMissing: "L’hôte ne détecte plus ce port. Le transfert existant reste actif.",
      loading: "Recherche des ports de l’espace de travail…",
      empty: "Aucun port en écoute n’a été trouvé pour cet espace de travail.",
      noWorkspace: "Ouvrez un espace de travail pour afficher ses ports.",
      hostDisconnected: "Reconnectez l’hôte pour utiliser le transfert de ports.",
      updateHost: "Mettez à jour le daemon hôte pour utiliser le transfert de ports.",
      unsupportedConnection: "Utilisez une connexion TCP ou relay pour transférer des ports.",
      discoveryUnavailable:
        "La détection automatique est indisponible. Saisissez un port manuellement.",
      actions: { forward: "Transférer", open: "Ouvrir", copy: "Copier", stop: "Arrêter" },
      states: {
      ...
      errors: {
        runtime: "Erreur de transfert de port",
        watch: "Impossible de charger les ports de l’espace de travail.",
        forward: "Impossible de transférer ce port.",
        stop: "Impossible d’arrêter ce transfert.",
        copy: "Impossible de copier l’adresse locale.",
        open: "Impossible d’ouvrir l’adresse locale.",
        desktopUpdate: "Mettez à jour l’application de bureau pour transférer des ports.",
      },
    },
    header: {
      actions: {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "L'archive n'est pas disponible ici car cet espace de travail n'a pas été créé en tant qu'arbre de travailHanabiCode",
          mergePrNoForge:
      ...
      commitComposer: {
        ...
        placeholder: "Decrivez vos changements",
        generate: "Generer",
        generating: "Generation...",
        generationFailed: "Impossible de generer un message de commit.",
        generationUnsupported: "Mettez a jour l'hote pour generer des messages de commit.",
        selectAll: "Selectionner tous les changements",
        selectedCount: "{{count}} sur {{total}} selectionnes",
        selectAtLeastOne: "Selectionnez au moins un fichier a valider.",
        includeFile: "Inclure {{path}} dans le commit",
        discardFile: "Annuler les changements dans {{path}}",
        commitFailed: "Impossible de valider les changements.",
      },
      sourceControl: {
        ...
        stageBeforeCommit: "Indexez des fichiers avant de valider.",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "LaissezHanabiCodedémarrer et arrêter le démon intégré",
        ...
        pausedStopFailed:
          "La gestion du démon intégré a été suspendue, maisHanabiCoden'a ​​pas pu arrêter le démon.",
      ...
      keepRunning: {
        ...
        hint: "Daemoncontinue de fonctionner lorsque vous quittezHanabiCode",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel: "Vous exécutez la versionInteldeHanabiCodesousRosettasurApple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Test de notificationHanabiCode",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Impossible d'installer leHanabiCodeCLI.",
      },
      skills: {
  ...
  rootError: {
    title: "HanabiCode a rencontré un problème.",
  ...
  pairing: {
    ...
    direct: {
      title: "Connexion directe",
      helper: "Saisissez l'adresse d'un serveurHanabiCode.",
      fields: {
        host: "Host",
        port: "Port",
    ...
    device: {
      ...
      relayDocsAccessibility: "Lire comment fonctionne le relais HanabiCode",
      ...
      updateRequired: "Mettez à jour l’hôte pour activer le relais depuis HanabiCode Desktop.",
      unavailable: "Offre de jumelage indisponible.",
      hint: "Scannez ce codeQRavecHanabiCodesur votre téléphone ou copiez le lien ci-dessous.",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "a appelé HanabiCode {{count}} fois",
      other: "a appelé HanabiCode {{count}} fois",
    },
    and: "et",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "HanabiCode a transmis la notification au système d’exploitation.",
    ...
    metadataGeneration: {
      ...
      description:
        "Choisissez le modèle utilisé par HanabiCode pour les titres d’espaces de travail, les noms de branches, les messages de commit et les brouillons de pull request",
      selection: "Sélection du modèle",
      automatic: "Automatique",
      preferred: "Manuel",
      automaticHint: "HanabiCode choisit un modèle rapide disponible",
      preferredHint: "Choisissez le modèle utilisé par HanabiCode",
      model: "Modèle",
      fallbackHint: "S’il est indisponible, HanabiCode utilise un autre modèle disponible",
      docs: "Documentation",
    ...
    general: {
      ...
      browserData: {
        ...
        description:
          "Les onglets du navigateur partagent les connexions et les données des sites dans HanabiCode.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Cela met à jourHanabiCodesur cet ordinateur",
    ...
    integrations: {
      ...
      skills: {
        ...
        updateTitle: "Mettre à jour les compétencesHanabiCode?",
        updateFallback: "Synchronisez les compétences regroupées sur votre machine.",
        uninstallTitle: "Désinstaller les compétencesHanabiCode?",
        uninstallMessage:
          "Supprime toutes les compétences d'orchestrationHanabiCodede ~/.agents, ~/.claude, ~/.codex.",
    ...
    host: {
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Activer les outilsHanabiCode",
          hint: "Les agents pourront gérer les arbres de travail, les agents et les horaires",
          accessibilityLabel: "Injecter les outilsHanabiCode",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Cet hôte est hors ligne.HanabiCodese reconnecte automatiquement: attendez qu'il soit de nouveau en ligne avant de redémarrer.",
          requestFailedTitle: "Erreur",
          requestFailedMessage:
            "Échec de l'envoi de la demande de redémarrage.HanabiCodese reconnecte automatiquement - réessayez une fois que l'hôte apparaît comme en ligne.",
          dialogFailedMessage:
            "Impossible d'ouvrir la boîte de dialogue de confirmation de redémarrage.",
        },
        update: {
          desktopManagedHint:
            "Ce daemon est géré par HanabiCode Desktop. Mettez à jour HanabiCode Desktop sur l’hôte.",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "HanabiCodesupervise le processus et attribue un port via $PASEO_PORT",
        actions: {
      ...
      metadata: {
        title: "Génération de métadonnées",
        info: "Instructions spécifiques au projet injectées dans les invites de l'IA queHanabiCodeutilise pour générer des métadonnées: utilisez-les pour appliquer les conventions de votre équipe telles que la dénomination des branches, le style de validation ou le formatPR.",
