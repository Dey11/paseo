...
const RELEASE_DOWNLOAD_BASE_URL = "https://github.com/Dey11/paseo/releases/download";
...
export function buildMacAppleSiliconDownloadUrl(version: string | null | undefined): string | null {
  ...
  return `${RELEASE_DOWNLOAD_BASE_URL}/hanabicode-v${normalizedVersion}/HanabiCode-${normalizedVersion}-arm64.dmg`;
}
