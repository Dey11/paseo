    ...
    it("uses the packaged runner when the desktop app is packaged", () => {
      expect(
        createNodeEntrypointInvocation({
          ...
          isPackaged: true,
          packagedRunnerPath:
            "/Applications/HanabiCode.app/Contents/Resources/app.asar/dist/daemon/node-entrypoint-runner.js",
        ...
        command: "/Applications/HanabiCode.app/Contents/MacOS/HanabiCode",
        args: [
