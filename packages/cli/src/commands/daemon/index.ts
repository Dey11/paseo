...
export function createDaemonCommand(): Command {
  const daemon = new Command("daemon").description("Manage the HanabiCode daemon");
  ...
  addJsonOption(daemon.command("restart").description("Restart the local daemon"))
    ...
    .option("--no-inject-mcp", "Disable auto-injecting the HanabiCode MCP into created agents")
