...
export function createCli(): Command {
  ...
  program
    .name("hanabicode")
    .description("HanabiCode CLI - control your AI coding agents from the command line")
  ...
  addJsonAndDaemonHostOptions(
    program
      .command("clone")
      .description("Clone a GitHub repo and register it as a HanabiCode workspace")
  ...
  addJsonOption(
    program
      .command("status")
      .description('Show local daemon status (alias for "hanabicode daemon status")'),
  )
  ...
  addJsonAndDaemonHostOptions(
    program
      .command("reload")
      .description('Reload daemon config (alias for "hanabicode daemon reload")'),
  ).action(withOutput(runDaemonReloadCommand));

  addJsonOption(
    program
      .command("restart")
      .description('Restart local daemon (alias for "hanabicode daemon restart")'),
  )
    .option("--home <path>", "HanabiCode home directory (default: ~/.hanabicode)")
