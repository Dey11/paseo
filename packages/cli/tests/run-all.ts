...
/**
 * Test runner for HanabiCode CLI E2E tests
 *
...
// packages live in the root. Prepend it so `npx hanabicode` resolves locally.
...
console.log("🧪 HanabiCode CLI E2E Test Runner\n");
console.log("=".repeat(50));
